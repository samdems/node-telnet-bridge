...
list = {
  ship_layout:function(user,telnet,menu) {
    ...
    gui = new screengui(user,telnet,"shipstats",output,menu);
    user.active = gui.receive;
    gui.render();
  },
  ship_stats:function(user,telnet,menu) {
    console.log("shipstats");
    gui = new screengui(user,telnet,"shipstats",function() {return ship.stats();},menu);
    user.active = gui.receive;
    gui.render();
  }
};
